$(document).ready(function () {
    ...
    $(".bt:eq(6)").click(function () {
      $(".body").html(`<form id="form">
              ...
              <div class="excel"><a href="Research sheet Template_Final.xlsm" download="Research sheet Template_Final.xlsm"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
